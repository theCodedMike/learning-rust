...
#### `impl<K, Q: ?Sized, V, S> Index<&Q> for HashMap<K, V, S> where K: Eq + Hash + Borrow<Q>, Q: Eq + Hash, S: BuildHasher`
...
#### `pub struct DrainFilter<'a, K, V, F> where F: FnMut(&K, &mut V) -> bool`
...
#### `impl<K, V> fmt::Debug for IterMut<'_, K, V> where K: fmt::Debug, V: fmt::Debug`
...
#### `impl<K, V> fmt::Debug for Drain<'_, K, V> where K: fmt::Debug, V: fmt::Debug`
#### `impl<K, V, F> Iterator for DrainFilter<'_, K, V, F> where F: FnMut(&K, &mut V) -> bool`
#### `impl<K, V, F> FusedIterator for DrainFilter<'_, K, V, F> where F: FnMut(&K, &mut V) -> bool`
#### `impl<'a, K, V, F> fmt::Debug for DrainFilter<'a, K, V, F> where F: FnMut(&K, &mut V) -> bool`
...
#### `fn map_raw_entry<'a, K: 'a, V: 'a, S: 'a>(raw: base::RawEntryMut<'a, K, V, S>) -> RawEntryMut<'a, K, V, S>`
