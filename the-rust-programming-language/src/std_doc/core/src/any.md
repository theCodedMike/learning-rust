...
#### `pub trait Provider`
#### `pub fn request_value<'a, T>(provider: &'a (impl Provider + ?Sized)) -> Option<T> where T: 'static`
#### `pub fn request_ref<'a, T>(provider: &'a (impl Provider + ?Sized)) -> Option<&'a T> where T: 'static + ?Sized`
#### `fn request_by_type_tag<'a, I>(provider: &'a (impl Provider + ?Sized)) -> Option<I::Reified> where I: tags::Type<'a>`
