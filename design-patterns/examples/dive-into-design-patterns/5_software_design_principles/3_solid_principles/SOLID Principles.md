...
principles. Robert Martin introduced them in the book [*Agile Software Development, Principles, Patterns, and Practices*](https://refactoring.guru/principles-book).   
译: 现在相信你已经了解了基本的设计原则，那就让我们来看看名为SOLID的五条原则吧。这五条原则是在罗伯特·马丁的著作[《敏捷软件开发：原则、模式与实践》](https://refactoringguru.cn/principles-book)
中首次提出的。
